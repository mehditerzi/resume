    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                $pdocrud->colRename("blog_id", "Blog");
                $pdocrud->fieldRenameLable("blog_id", "Blog");
                ...
                // get departments
                $data =  $pdocrud->getPDOModelObj()->select("blog");
                $options = array();
                ...
                $pdocrud->fieldTypes("blog_id", "select");
                $pdocrud->fieldDataBinding("blog_id", $options, "", "","array");
                echo $pdocrud->dbTable("publication")->render();
