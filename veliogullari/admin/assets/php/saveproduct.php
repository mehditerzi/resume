...
id = ?");
    $insert = $query->execute(array(
        $_POST['name'], "/data/products/".$_POST['category_id'].$_POST['brand_id'].$_POST['name'].'.png', $_POST['description'],
        $_POST['barcode'],$_POST['price'],$_POST['issale'],$saleprice,$_POST['quantity'],$_POST['brand_id'],$_POST['category_id'],$slug,$_POST['taxlessbuyprice'],$_POST['taxedbuyprice'],$_POST['tax'],$_POST['id']
    ));
    if ( $insert ){
...
id = ?");
    $insert = $query->execute(array(
        ...
        $_POST['barcode'],$_POST['price'],$_POST['issale'],$saleprice,$_POST['quantity'],$_POST['brand_id'],$_POST['category_id'],$slug,$_POST['id']
    ));
    if ( $insert ){
        $last_id = $db->lastInsertId();
        print "Başarılı";
